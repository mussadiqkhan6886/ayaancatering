...
const SayEnd = () => {
  return (
    <section className='bg-main flex items-center overflow-hidden min-h-screen justify-center flex-col py-10 my-10 relative gap-4'>
      ...
      <Image src={"/art.png"} alt='image' width={300} height={300} className='bottom-0 left-3 sm:left-10 lg:left-50 absolute object-cover object-center h-[150px] w-[150px] md:w-[300px] md:h-[300px]' />
    </section>
  )
}
